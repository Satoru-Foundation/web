            ...
            item.subItems ? (
              <div key={index} className="relative group">
                ...
                <motion.div
                  ...
                  className="absolute top-full left-0 mt-2 w-48 bg-white shadow-lg rounded-md opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50"
                >
                  {item.subItems.map((subItem, subIndex) => (
                    ...
                    >
                      <Link
                        href={subItem.href}
                        className="block px-4 py-2 text-[#5e6f47] font-semibold text-lg transition-colors duration-300 hover:text-[#ecc750]"
                      >
                        {subItem.name}
                      </Link>
                      <span className="absolute left-0 bottom-0 w-0 h-[2px] bg-[#ecc750] hover:w-full transition-all duration-300"></span>
                    </motion.div>
                  ))}
                </motion.div>
              </div>
