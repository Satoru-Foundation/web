        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="max-w-3xl mx-auto text-left space-y-8">
            ...
            <div>
              ...
              <p className="text-gray-600">
                The donations are used for senior citizen welfare initiatives and for the improvement of health(physical and mental) and overall wellbeing of senior citizens.
              </p>
            </div>
            <div>
              <h3 className="text-xl font-bold mb-2 text-gray-800">
            ...
            <div>
              ...
              <p className="text-gray-600">
                Yes you'll get tax benefits by donating to our organization.
              </p>
            </div>
          </div>
        </div>
